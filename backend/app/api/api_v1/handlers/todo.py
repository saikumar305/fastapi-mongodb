...
@todo_router.post('/create', summary="Create Todo", response_model=Todo , response_model_exclude={'owner':{'hashed_password'}})
...
@todo_router.get('/{todo_id}', summary="Get a todo by todo_id", response_model=TodoOut | None)
